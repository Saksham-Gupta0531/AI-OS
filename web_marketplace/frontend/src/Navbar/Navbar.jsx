        ...
        <nav className="text-white w-full h-[12vh] flex font-sans fixed">
            ...
            <div className="part-II w-[60%] h-full flex justify-center items-center">
                <ul className="flex gap-10 text-md text-[#AFAFAF] font-medium">
                    ...
                    <li className="hover:text-white cursor-pointer transition-colors duration-200 mt-2">Documents</li>
                    <li className="hover:text-white cursor-pointer transition-colors duration-200 mt-2">Contact</li>
                    {!user && (
                        <li
